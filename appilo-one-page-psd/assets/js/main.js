	...
	$.fn.sinaNav = function () {
		return this.each( function() {
			...
			function freezNav() {
				...
				else if( winWidth < 1200 && winWidth > 992 && scrollTop > mdTop ){
					getNav.addClass('navbar-freez');
				}
				else {
			...
			if( getNav.hasClass('navbar-fixed') ){
				...
				if ( getWindow > 992 && $(window).scrollTop() > top ) {
					getNav.addClass('navbar-freez');
				}
			}
...
$(document).ready(function(){
    ...
    // Start Portfolio Tabing (jQuery Isotop Meshonary Plugin)
    ...
    // Start Testmonial Card Slider (SLick Slider)
    $('.responsive').slick({
      dots: true,
      infinite: false,
      speed: 300,
  ...
  // End Testmonial Card Slider (SLick Slider)
